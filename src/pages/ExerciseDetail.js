  ...
  useEffect(()=>{
    ...
    const fetchExerciseData=async()=>{
      ...
      const youtubeSearchUrl =
        ...
        const targetMuscleResult = await targetMuscleExercisesData.json();
        setTargetMuscleExercises(targetMuscleResult);
        
        const equipmentExercisesData = await fetch(`${exerciseDbUrl}/exercises/equipment/${exerciseDetailData.equipment}`,exerciseOptions);
        const equipmentExerciseResult = await equipmentExercisesData.json();
        setEquipmentExercises(equipmentExerciseResult);
      }
      fetchExerciseData();
    },[id]);
